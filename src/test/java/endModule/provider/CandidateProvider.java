...
public class CandidateProvider {
    @DataProvider(name = "OrangeHRM_Candidate_Data")
    public Object[][] OrangeHRM_Candidate_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/endModule/data/candidateData.json";
