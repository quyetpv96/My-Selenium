...
public class AddEventProvider {
    @DataProvider(name = "RISE_AddEvent_Data")
    public Object[][] RISE_AddEvent_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lesson13/data/eventData.json";
