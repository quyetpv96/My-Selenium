...
public class Module2Provider {
    @DataProvider(name = "RISE_Module2_Data")
    public Object[][] RISE_Module2_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lesson13/data/module2Data.json";
