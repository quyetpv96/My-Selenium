...
public class ClientPage extends BasePage {
    ...
    public AddClientPage gotoAddClientPage(){
        logger.info("Click to add Client");
        String addClientXPath = "//a[@data-action-url='https://rise.fairsketch.com/clients/modal_form']";
        clickElement(By.xpath(addClientXPath));

        return new AddClientPage(mWebDriver);
    }
}
