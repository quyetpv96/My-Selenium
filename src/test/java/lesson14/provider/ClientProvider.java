...
public class ClientProvider {
    @DataProvider(name = "RISE_AddClient")
    public Object[][] RISE_AddClient_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lesson14/data/clientData.json";
