...
public class Practice14Provider {
    @DataProvider(name = "RISE_Project_Data")
    public Object[][] RISE_Project_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lesson14/data/practice14Data.json";
