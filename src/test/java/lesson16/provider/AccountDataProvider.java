...
public class AccountDataProvider {
    @DataProvider(name = "RISE_Account_Data")
    public Object[][] RISE_Account_Data(Method method) {
        // Read content from data file
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lesson16/data/accountData.json";
