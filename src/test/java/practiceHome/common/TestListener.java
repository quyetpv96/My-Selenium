package practiceHome.common;

import com.aventstack.extentreports.Status;
import practiceHome.pages.LoginPage;
import practiceHome.report.ExtentReportManager;
import practiceHome.report.ExtentTestManager;
import practiceHome.report.Log;
...
public class TestListener implements ITestListener, ISuiteListener {
    ...
    public void onStart(ISuite iSuite) {
        logger.info("== Midou : Start TestSuite");
        // On Start Suite
    ...
    public void onFinish(ISuite iSuite) {
        logger.info("== Midou : Finish TestSuite");
    ...
    public void onTestStart(ITestResult iTestResult) {
        ...
        logger.info("== Midou : START TC "+ getTestName(iTestResult));
        totalTCs++;
    ...
    public void onTestSuccess(ITestResult iTestResult) {
        ...
        logger.info(String.format("== Midou : COMPLETED TC %s: PASS",iTestResult.isSuccess()));
        passedTCs++;
    ...
    public void onTestFailure(ITestResult iTestResult) {
        logger.info(String.format("== Midou : COMPLETED TC %s: FAILED",iTestResult.isSuccess()));
        failedTCs++;
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        logger.info(String.format("== Midou : COMPLETED TC %s: SKIPPED",iTestResult.isSuccess()));
        skippedTCs++;
